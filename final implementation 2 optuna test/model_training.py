...
def train_model(model, train_loader, val_loader, action_weights, lr, weight_decay):
    """
    Handles the complete training and validation loop for the model.
    Includes optimizer, scheduler, early stopping, and gradient clipping.
    """
