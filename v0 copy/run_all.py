...
def main():
    ...
    model = NMSTPP_Sequential(
        ...
        # MODIFIZIERT: Modellgröße von 128 auf 256 erhöht
        d_model=256, 
        nhead=8, # Es ist üblich, die Anzahl der Heads mit d_model zu skalieren
        num_layers=4, # Mehr Layer für mehr Kapazität
        dropout_rate=0.4 # Explizite Übergabe des neuen Parameters
    )
