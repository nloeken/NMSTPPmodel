...
from utils import make_dataloaders, get_manual_scaled_weights
...
def run_training_pipeline():
    ...
    def objective(trial: optuna.Trial):
        ...
        # --- ÄNDERUNG HIER: Korrigierte Funktionsaufrufe ---
        # 1. Berechne die Gewichte SEPARAT mit der neuen Funktion
        action_weights = get_manual_scaled_weights(df_featured)
        
        # 2. Erstelle die Loader. Diese Funktion gibt jetzt nur noch 2 Werte zurück.
        train_loader, val_loader = make_dataloaders(X, y, batch_size)
        
        # Die ursprünglichen Daten werden nicht mehr gebraucht
        del df, df_featured
        gc.collect()
        
        # Das Modell wird wie zuvor initialisiert
        ...
        # Das Trainingsmodell erhält die separat berechneten Gewichte
        model = train_model(
