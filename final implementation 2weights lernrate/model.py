...
class NMSTPP_Sequential(nn.Module):
    """
    Angepasste Version: Verwendet eine einzelne TransformerEncoderLayer mit nhead=1.
    """
    def __init__(self, cont_dim, dim_360, seq_len, 
                 num_zones, num_actions, zone_emb_dim=16, action_emb_dim=16,
                 d_model=128, hidden_dim=128, 
        ...
        # --- ÄNDERUNG: Transformer ---
        # Statt eines gestapelten Encoders wird nur eine einzige Schicht verwendet.
        # nhead ist fest auf 1 gesetzt, wie im Code des Papers.
        self.transformer_layer = nn.TransformerEncoderLayer(
            d_model=d_model, nhead=1, dim_feedforward=hidden_dim, batch_first=True
        )
    ...
    def forward(self, x_cat, x_cont, x_360=None):
        ...
        # --- ÄNDERUNG: Transformer Call ---
        # Die Daten werden nur noch durch die eine Schicht geleitet.
